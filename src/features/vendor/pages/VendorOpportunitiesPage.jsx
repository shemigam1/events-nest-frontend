...
export default function VendorOpportunitiesPage() {
    ...
    // We pull the user's existing applications so each card knows whether
    // they've already applied — no double-pitching the same event.
...
/* ─── Apply modal ─────────────────────────────────── */
function ApplyAsVendorModal({ event, onClose }) {
                    ...
                    {submitted ? (
                        <>
                            ...
                            <p className="body-sm" style={{ color: 'var(--text-2)', marginTop: 8, textAlign: 'center' }}>
                                We&apos;ll notify the organiser. Track the status from My applications.
                            </p>
                            <Button
                                variant="primary"
                                size="md"
